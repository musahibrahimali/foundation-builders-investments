    ...
    <Box css={{}}>
        <Tabs defaultValue="tab1">
            <TabsList aria-label="Manage your account">
                <TabsTrigger value="tab1">Mobile Money</TabsTrigger>
                <TabsTrigger value="tab2">Bank Card</TabsTrigger>
            </TabsList>
            <TabsContent value="tab1">
                <Fieldset>
                    <Label htmlFor="name">Amount</Label>
                    <Input id="name" defaultValue="$100" />
                </Fieldset>
                <Flex css={{ marginTop: 20, justifyContent: 'flex-end' }}>
                    <Button variant="green">Proceed</Button>
                </Flex>
            </TabsContent>
